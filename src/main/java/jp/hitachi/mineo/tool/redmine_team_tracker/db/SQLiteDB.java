package jp.hitachi.mineo.tool.redmine_team_tracker.db;
...
public class SQLiteDB {
  ...
  public static Connection getConnection() {
    val sqliteDbUrl = "jdbc:sqlite:output.db";
  ...
  public static void createSQLiteTable(Connection sqliteConn) throws SQLException {
    val sql = "CREATE TABLE IF NOT EXISTS ticket_aggregation (" +
        "date TEXT, " +
        "team_name TEXT, " +
  ...
  public static void insertAggregation(Connection sqliteConn, Aggregation aggregation) {
    val sql = "INSERT INTO ticket_aggregation (date, team_name, incomplete_increase, incomplete_total) " +
        "VALUES (?, ?, ?, ?) " +
