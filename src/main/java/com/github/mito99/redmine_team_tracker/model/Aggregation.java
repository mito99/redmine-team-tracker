...
import static com.github.mito99.redmine_team_tracker.util.ThrowingConsumer.tryConsumer;
import java.time.LocalDate;
import java.util.HashMap;
import java.util.Map;
import java.util.stream.Stream;
import com.github.mito99.redmine_team_tracker.util.ThrowingConsumer;
...
public class Aggregation {
  ...
  public TeamStats get(LocalDate date, String teamName) {
    ...
    values.putIfAbsent(key, TeamStats.builder().date(date).teamName(teamName).build());
