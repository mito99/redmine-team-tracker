...
public class IssueTeamHistoriesTest {
  ...
  void 当日担当となったチーム名が取得できるか() {
    val issue = Issue.builder().createdOn("2024-05-07 16:17:35").teamName("Aチーム").build();

    val journals = Arrays.asList(new Journal[] {new Journal("2024-05-16 13:59:02", "Bチーム", "Aチーム"),
